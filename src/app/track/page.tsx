        ...
        <div className="max-w-md w-full">
          <div className="text-center mb-8">
            <div
              ...
              style={{ background: 'rgba(201,165,88,0.15)', border: '1px solid rgba(201,165,88,0.3)' }}
            >
              <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#c9a558" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                <circle cx="11" cy="11" r="8" />
                <path d="m21 21-4.35-4.35" />
              </svg>
            </div>
            <h1 className="text-3xl font-bold mb-2" style={{ color: '#f5f7fa' }}>Track Your Job</h1>
            <p style={{ color: '#8a9bb0' }}>Enter the tracking code from your confirmation.</p>
          </div>
          ...
          <p className="text-center text-sm mt-6">
            <Link href="/submit" style={{ color: '#c9a558' }} className="underline">
