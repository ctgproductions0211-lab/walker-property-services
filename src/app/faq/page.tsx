...
export const metadata: Metadata = {
  ...
  description: 'Answers to common questions about cleanouts, demolition, service areas, free estimates, and documentation from Walker Property Services in Philadelphia.',
}
